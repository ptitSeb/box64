...
GO("libmbedtls.so", mbedtls)
GO("libmbedx509.so", mbedx509)
GO("libmbedcrypto.so", mbedcrypto)
#else
GO("libc.so.6", libc)
GO("libm.so.6", libm)
GO("libdl.so.2", libdl)
...
GO("libmbedtls.so.14", mbedtls)
GO("libmbedtls.so.12", mbedtls)
GO("libmbedx509.so.1", mbedx509)
GO("libmbedx509.so.0", mbedx509)
GO("libmbedcrypto.so.7", mbedcrypto)
GO("libmbedcrypto.so.3", mbedcrypto)
#endif
#ifdef TERMUX
