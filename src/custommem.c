...
void* map128_customMalloc(size_t size, int is32bits)
{
    ...
    if(last_block_index_map128 >= 0 && last_block_index_map128 < n_blocks) {
        ...
        if(hint->block && (hint->type == BTYPE_MAP) && hint->maxfree && (hint->is32bits==is32bits)) {
...
void* map64_customMalloc(size_t size, int is32bits)
{
    ...
    if(last_block_index_map64 >= 0 && last_block_index_map64 < n_blocks) {
        ...
        if (hint->block
         && hint->type == BTYPE_MAP64
         && hint->maxfree
         && (hint->is32bits==is32bits)
        ) {
...
void* internal_customMalloc(size_t size, int is32bits)
{
    ...
    if(last_block_index_list >= 0 && last_block_index_list < n_blocks) {
        ...
        if(hint->block && (hint->type == BTYPE_LIST) && hint->maxfree>=init_size && (hint->is32bits==is32bits)) {
            size_t rsize = 0;
