...
GO(SDL_strrev, pFp)
GO(SDL_strstr, pFpp)
GO(SDL_strtod, dFpbp_)
GO(SDL_strtol, lFpbp_i)
GO(SDL_strtoll, IFpbp_i)
GO(SDL_strtoul, LFpbp_i)
GO(SDL_strtoull, UFpbp_i)
GO(SDL_strupr, pFp)
GO(SDL_ulltoa, pFUpi)
GO(SDL_ultoa, pFLpi)
