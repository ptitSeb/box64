...
// towctrans_l  // Weak
GO(towlower, uFu)
GO(__towlower_l, uFua)
GOW(towlower_l, uFua)
GO(towupper, uFu)
GO(__towupper_l, uFua)
GOW(towupper_l, uFua)
// tr_break
//GOW(truncate, iFpu)
GO(truncate64, iFSU)
