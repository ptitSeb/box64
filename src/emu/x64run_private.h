...
uintptr_t Test66F20F(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t Test66F30F(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t Test6664(x64test_t *test, rex_t rex, int seg, uintptr_t addr, int *notest);
uintptr_t Test66D9(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t Test66DD(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t Test66F0(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
...
uintptr_t Test6764_32(x64test_t *test, rex_t rex, int rep, int seg, uintptr_t addr, int *notest);
uintptr_t Test670F(x64test_t *test, rex_t rex, int rep, uintptr_t addr, int *notest);
uintptr_t Test6766(x64test_t *test, rex_t rex, int rep, uintptr_t addr, int *notest);
uintptr_t Test67660F(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestD8(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestD9(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDA(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDB(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDC(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDD(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDE(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
uintptr_t TestDF(x64test_t *test, rex_t rex, uintptr_t addr, int *notest);
