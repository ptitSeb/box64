            ...
            if (box64_log >= LOG_DEBUG || cycle_log) {
                ...
                if (post)
                    switch (post) { // Only ever 2 for now...
                        case 1:
                            snprintf(buff2, 64, " [%llu sec %llu nsec]", pu64 ? pu64[0] : ~0ull, pu64 ? pu64[1] : ~0ull);
                            break;
                        case 2:
                            snprintf(buff2, 64, "(%s)", R_RAX ? ((char*)R_RAX) : "nil");
                            break;
                        case 3:
                            snprintf(buff2, 64, "(%s)", pu64 ? ((char*)pu64) : "nil");
                            break;
                        case 4:
                            snprintf(buff2, 64, " (%f)", ST0.d);
                            break;
                        case 5: {
                        ...
                        case 6:
                            if (pu32) snprintf(buff2, 64, " [0x%x] ", pu32[0]);
                            break;
                        case 7:
                            if (pu32) snprintf(buff2, 64, " [%d, %d] ", pu32[0], pu32[1]);
                            break;
                        case 8:
                            if (pu8 && S_RAX != -1) {
                                char buff5[64] = "";
