...
#define native_lock_inc(A)                  arm64_lock_inc(A)
...
#define native_lock_inc(A)                  rv64_lock_inc(A)
...
#define native_lock_inc(A)                  la64_lock_inc(A)
...
#define native_lock_inc(A)                  ppc64le_lock_inc(A)
