...
r10     a6     RAX          Function argument               -                       Caller
r11     a7     x7           Function argument               Scratch                 Caller
r12     t0     -            Temporary                       ?                       Caller
...
r19     t7     R10          Temporary                       Scratch                 Caller
r20     t8     R11          Temporary                       Scratch                 Caller
r21     rx     -            Reserved                        N/A                     -
r22     fp     RBP          Saved register/frame pointer    -                       Callee
r23     s0     RSP          Saved register                  -                       Callee
r24     s1     R12          Saved register                  -                       Callee
r25     s2     R13          Saved register                  -                       Callee
r26     s3     R14          Saved register                  -                       Callee
r27     s4     R15          Saved register                  -                       Callee
r28     s5     RIP          Saved register                  -                       Callee
r29     s6     FLAGS        Saved register                  -                       Callee
r30     s7     RBX          Saved register                  -                       Callee
...
#define TO_NAT(A) (((uint8_t[]) { 10, 7, 6, 30, 23, 22, 5, 4, 8, 9, 19, 20, 24, 25, 26, 27 })[(A)])
