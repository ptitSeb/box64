...
typedef enum la64_consts_s {
    ...
    const_la64_vpaes_enc_tables,
    const_la64_vpaes_dec_tables,
    const_la64_vpaes_keygen_tables,
    const_la64_vpaes_enc_tables_xv,
    const_la64_vpaes_dec_tables_xv,
    const_native_pclmul,
    ...
    const_la64_snapshot_match,
    const_la64_snapshot_match_lasx,
    const_int3,
    const_x86syscall,
    const_x64syscall,
