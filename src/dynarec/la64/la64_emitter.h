...
#define VFRINTRNE_D(vd, vj)          EMIT(type_2R(0b0111001010011101011110, vj, vd))
#define VFRINTRM_D(vd, vj)           EMIT(type_2R(0b0111001010011101010010, vj, vd))
#define VFRINTRP_D(vd, vj)           EMIT(type_2R(0b0111001010011101010110, vj, vd))
#define VFRINTRZ_D(vd, vj)           EMIT(type_2R(0b0111001010011101011010, vj, vd))
#define XVREPLVE0_D(vd, vj)          EMIT(type_2R(0b0111011100000111111000, vj, vd))
#define XVINSVE0_D(vd, vj, imm2)     EMIT(type_2RI2(0b01110110111111111110, imm2, vj, vd))
#define XVINSGR2VR_D(vd, rj, imm2)   EMIT(type_2RI2(0b01110110111010111110, imm2, rj, vd))
