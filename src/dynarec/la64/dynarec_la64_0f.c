    ...
    switch (opcode) {
        ...
        case 0x2C:
            ...
            if (BOX64ENV(dynarec_fastround)) {
                ...
                AND(x5, x5, x3);
                BEQZ_MARK3(x5); // no exception, work done.
                ...
                MOVGR2FCSR(FCSR2, xZR);  // reset all bits
                VSHUF4I_W(q0, v1, 0b01); // get v1 high part
                FTINTRZ_W_S(q0, q0);
                MOVFCSR2GR(x5, FCSR2); // get back FPSR to check
                AND(x5, x5, x3);
                BEQZ_MARK2(x5);
...
#undef GO
        ...
        case 0xF6:
            ...
            GETGM(v0);
            GETEM(v1, 0);
            VABSD_BU(v0, v0, v1);     // get delta abs
            VHADDW_HU_BU(v0, v0, v0); // even pos 8bits + odd pos 8bits => 16bits
            VHADDW_WU_HU(v0, v0, v0); // even pos 16bits + odd pos 16bits => 32bits
            VHADDW_DU_WU(v0, v0, v0); // even pos 32bits + odd pos 32bits => 64bits
            break;
        case 0xF7:
            ...
            q0 = fpu_get_scratch(dyn);
            q1 = fpu_get_scratch(dyn);
            VSRA_B(q1, v1, 7); // q1 = byte slection mask
            FLD_D(q0, xRDI, 0);
