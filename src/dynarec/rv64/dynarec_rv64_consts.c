...
uintptr_t getConst(rv64_consts_t which)
{
    switch(which) {
        ...
        case const_native_aesd: return (uintptr_t)((cpuext.vector && !cpuext.xtheadvector) ? rvv_aesd : native_aesd);
        case const_native_aesd_y: return (uintptr_t)native_aesd_y;
        case const_native_aesdlast: return (uintptr_t)((cpuext.vector && !cpuext.xtheadvector) ? rvv_aesdlast : native_aesdlast);
        case const_native_aesdlast_y: return (uintptr_t)native_aesdlast_y;
        case const_native_aese: return (uintptr_t)((cpuext.vector && !cpuext.xtheadvector) ? rvv_aese : native_aese);
        case const_native_aese_y: return (uintptr_t)native_aese_y;
        case const_native_aeselast: return (uintptr_t)((cpuext.vector && !cpuext.xtheadvector) ? rvv_aeselast : native_aeselast);
