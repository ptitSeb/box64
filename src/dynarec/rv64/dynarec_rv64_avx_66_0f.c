        ...
        case 0x72:
            ...
            switch ((nextop >> 3) & 7) {
                ...
                case 4:
                    ...
                    for (int i = 0; i < 4; ++i) {
                        LW(x4, wback, fixedaddress + 4 * i);
                        SRAI(x4, x4, (u8 > 31) ? 31 : u8);
                        SW(x4, vback, vxoffset + 4 * i);
                    }
                    if (vex.l) {
                        GETEY();
            ...
            switch ((nextop >> 3) & 7) {
                ...
                case 3:
                    ...
                    if (u8 > 15) {
                        ...
                        OR(x6, x6, x4);
                        SRLI(x5, x5, u8 * 8);
                        SD(x6, vback, vxoffset + 0);
                        SD(x5, vback, vxoffset + 8);
                    } else {
                        LD(x4, wback, fixedaddress + 8);
                        SRLI(x4, x4, (u8 - 8) * 8);
