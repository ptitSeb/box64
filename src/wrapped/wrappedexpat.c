...
#define GO(A) \
    if (my_Start_fct_##A == (uintptr_t)fct) return my_Start_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_Start_fct_##A == 0) {           \
        my_Start_fct_##A = (uintptr_t)fct; \
        return my_Start_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_End_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_End_fct_##A == (uintptr_t)fct) return my_End_##A;
    SUPER()
#undef GO
#define GO(A)                            \
    if (my_End_fct_##A == 0) {           \
        my_End_fct_##A = (uintptr_t)fct; \
        return my_End_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_CharData_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_CharData_fct_##A == (uintptr_t)fct) return my_CharData_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_CharData_fct_##A == 0) {           \
        my_CharData_fct_##A = (uintptr_t)fct; \
        return my_CharData_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_StartNamespaceDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_StartNamespaceDecl_fct_##A == (uintptr_t)fct) return my_StartNamespaceDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_StartNamespaceDecl_fct_##A == 0) {           \
        my_StartNamespaceDecl_fct_##A = (uintptr_t)fct; \
        return my_StartNamespaceDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_EndNamespaceDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_EndNamespaceDecl_fct_##A == (uintptr_t)fct) return my_EndNamespaceDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_EndNamespaceDecl_fct_##A == 0) {           \
        my_EndNamespaceDecl_fct_##A = (uintptr_t)fct; \
        return my_EndNamespaceDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_StartElement_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_StartElement_fct_##A == (uintptr_t)fct) return my_StartElement_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_StartElement_fct_##A == 0) {           \
        my_StartElement_fct_##A = (uintptr_t)fct; \
        return my_StartElement_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_EndElement_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_EndElement_fct_##A == (uintptr_t)fct) return my_EndElement_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_EndElement_fct_##A == 0) {           \
        my_EndElement_fct_##A = (uintptr_t)fct; \
        return my_EndElement_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_CharacterData_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_CharacterData_fct_##A == (uintptr_t)fct) return my_CharacterData_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_CharacterData_fct_##A == 0) {           \
        my_CharacterData_fct_##A = (uintptr_t)fct; \
        return my_CharacterData_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ProcessingInstruction_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ProcessingInstruction_fct_##A == (uintptr_t)fct) return my_ProcessingInstruction_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_ProcessingInstruction_fct_##A == 0) {           \
        my_ProcessingInstruction_fct_##A = (uintptr_t)fct; \
        return my_ProcessingInstruction_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_Comment_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_Comment_fct_##A == (uintptr_t)fct) return my_Comment_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_Comment_fct_##A == 0) {           \
        my_Comment_fct_##A = (uintptr_t)fct; \
        return my_Comment_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_StartCdataSection_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_StartCdataSection_fct_##A == (uintptr_t)fct) return my_StartCdataSection_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_StartCdataSection_fct_##A == 0) {           \
        my_StartCdataSection_fct_##A = (uintptr_t)fct; \
        return my_StartCdataSection_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_EndCdataSection_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_EndCdataSection_fct_##A == (uintptr_t)fct) return my_EndCdataSection_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my_EndCdataSection_fct_##A == 0) {           \
        my_EndCdataSection_fct_##A = (uintptr_t)fct; \
        return my_EndCdataSection_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_Default_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_Default_fct_##A == (uintptr_t)fct) return my_Default_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_Default_fct_##A == 0) {           \
        my_Default_fct_##A = (uintptr_t)fct; \
        return my_Default_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_StartDoctypeDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_StartDoctypeDecl_fct_##A == (uintptr_t)fct) return my_StartDoctypeDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_StartDoctypeDecl_fct_##A == 0) {           \
        my_StartDoctypeDecl_fct_##A = (uintptr_t)fct; \
        return my_StartDoctypeDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_EndDoctypeDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_EndDoctypeDecl_fct_##A == (uintptr_t)fct) return my_EndDoctypeDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_EndDoctypeDecl_fct_##A == 0) {           \
        my_EndDoctypeDecl_fct_##A = (uintptr_t)fct; \
        return my_EndDoctypeDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_EntityDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_EntityDecl_fct_##A == (uintptr_t)fct) return my_EntityDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_EntityDecl_fct_##A == 0) {           \
        my_EntityDecl_fct_##A = (uintptr_t)fct; \
        return my_EntityDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ElementDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ElementDecl_fct_##A == (uintptr_t)fct) return my_ElementDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_ElementDecl_fct_##A == 0) {           \
        my_ElementDecl_fct_##A = (uintptr_t)fct; \
        return my_ElementDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_UnknownEncoding_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_UnknownEncoding_fct_##A == (uintptr_t)fct) return my_UnknownEncoding_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my_UnknownEncoding_fct_##A == 0) {           \
        my_UnknownEncoding_fct_##A = (uintptr_t)fct; \
        return my_UnknownEncoding_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_UnparsedEntityDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_UnparsedEntityDecl_fct_##A == (uintptr_t)fct) return my_UnparsedEntityDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_UnparsedEntityDecl_fct_##A == 0) {           \
        my_UnparsedEntityDecl_fct_##A = (uintptr_t)fct; \
        return my_UnparsedEntityDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_NotationDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_NotationDecl_fct_##A == (uintptr_t)fct) return my_NotationDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_NotationDecl_fct_##A == 0) {           \
        my_NotationDecl_fct_##A = (uintptr_t)fct; \
        return my_NotationDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_NotStandalone_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_NotStandalone_fct_##A == (uintptr_t)fct) return my_NotStandalone_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_NotStandalone_fct_##A == 0) {           \
        my_NotStandalone_fct_##A = (uintptr_t)fct; \
        return my_NotStandalone_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ExternalEntityRef_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ExternalEntityRef_fct_##A == (uintptr_t)fct) return my_ExternalEntityRef_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_ExternalEntityRef_fct_##A == 0) {           \
        my_ExternalEntityRef_fct_##A = (uintptr_t)fct; \
        return my_ExternalEntityRef_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_XmlDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XmlDecl_fct_##A == (uintptr_t)fct) return my_XmlDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_XmlDecl_fct_##A == 0) {           \
        my_XmlDecl_fct_##A = (uintptr_t)fct; \
        return my_XmlDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_AttlistDecl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_AttlistDecl_fct_##A == (uintptr_t)fct) return my_AttlistDecl_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_AttlistDecl_fct_##A == 0) {           \
        my_AttlistDecl_fct_##A = (uintptr_t)fct; \
        return my_AttlistDecl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_SkippedEntity_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_SkippedEntity_fct_##A == (uintptr_t)fct) return my_SkippedEntity_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_SkippedEntity_fct_##A == 0) {           \
        my_SkippedEntity_fct_##A = (uintptr_t)fct; \
        return my_SkippedEntity_##A;               \
    }
    SUPER()
#undef GO
