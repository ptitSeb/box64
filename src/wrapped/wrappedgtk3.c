...
static void* findGtkFunctionFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my3_gtkfunction_fct_##A == (uintptr_t)fct) return my3_gtkfunction_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my3_gtkfunction_fct_##A == 0) {           \
        my3_gtkfunction_fct_##A = (uintptr_t)fct; \
        return my3_gtkfunction_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGtkCallbackFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my3_gtkcallback_fct_##A == (uintptr_t)fct) return my3_gtkcallback_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my3_gtkcallback_fct_##A == 0) {           \
        my3_gtkcallback_fct_##A = (uintptr_t)fct; \
        return my3_gtkcallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGtkPrintJobCompleteHuncFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GtkPrintJobCompleteHunc_fct_##A == (uintptr_t)fct) return my_GtkPrintJobCompleteHunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                \
    if (my_GtkPrintJobCompleteHunc_fct_##A == 0) {           \
        my_GtkPrintJobCompleteHunc_fct_##A = (uintptr_t)fct; \
        return my_GtkPrintJobCompleteHunc_##A;               \
    }
    SUPER()
#undef GO
