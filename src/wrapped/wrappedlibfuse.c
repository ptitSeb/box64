...
#define GO(A) \
    if (my_fuse_opt_proc_fct_##A == (uintptr_t)fct) return my_fuse_opt_proc_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_fuse_opt_proc_fct_##A == 0) {           \
        my_fuse_opt_proc_fct_##A = (uintptr_t)fct; \
        return my_fuse_opt_proc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_init_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_init_fct_##A == (uintptr_t)fct) return my_init_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_init_fct_##A == 0) {           \
        my_init_fct_##A = (uintptr_t)fct; \
        return my_init_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_lookup_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_lookup_fct_##A == (uintptr_t)fct) return my_lookup_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_lookup_fct_##A == 0) {           \
        my_lookup_fct_##A = (uintptr_t)fct; \
        return my_lookup_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_forget_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_forget_fct_##A == (uintptr_t)fct) return my_forget_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_forget_fct_##A == 0) {           \
        my_forget_fct_##A = (uintptr_t)fct; \
        return my_forget_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getattr_fct_##A == (uintptr_t)fct) return my_getattr_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_getattr_fct_##A == 0) {           \
        my_getattr_fct_##A = (uintptr_t)fct; \
        return my_getattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_setattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_setattr_fct_##A == (uintptr_t)fct) return my_setattr_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_setattr_fct_##A == 0) {           \
        my_setattr_fct_##A = (uintptr_t)fct; \
        return my_setattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_readlink_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_readlink_fct_##A == (uintptr_t)fct) return my_readlink_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_readlink_fct_##A == 0) {           \
        my_readlink_fct_##A = (uintptr_t)fct; \
        return my_readlink_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_mknod_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_mknod_fct_##A == (uintptr_t)fct) return my_mknod_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_mknod_fct_##A == 0) {           \
        my_mknod_fct_##A = (uintptr_t)fct; \
        return my_mknod_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_mkdir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_mkdir_fct_##A == (uintptr_t)fct) return my_mkdir_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_mkdir_fct_##A == 0) {           \
        my_mkdir_fct_##A = (uintptr_t)fct; \
        return my_mkdir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_unlink_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_unlink_fct_##A == (uintptr_t)fct) return my_unlink_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_unlink_fct_##A == 0) {           \
        my_unlink_fct_##A = (uintptr_t)fct; \
        return my_unlink_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_rmdir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_rmdir_fct_##A == (uintptr_t)fct) return my_rmdir_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_rmdir_fct_##A == 0) {           \
        my_rmdir_fct_##A = (uintptr_t)fct; \
        return my_rmdir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_symlink_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_symlink_fct_##A == (uintptr_t)fct) return my_symlink_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_symlink_fct_##A == 0) {           \
        my_symlink_fct_##A = (uintptr_t)fct; \
        return my_symlink_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_rename_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_rename_fct_##A == (uintptr_t)fct) return my_rename_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_rename_fct_##A == 0) {           \
        my_rename_fct_##A = (uintptr_t)fct; \
        return my_rename_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_link_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_link_fct_##A == (uintptr_t)fct) return my_link_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_link_fct_##A == 0) {           \
        my_link_fct_##A = (uintptr_t)fct; \
        return my_link_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_open_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_open_fct_##A == (uintptr_t)fct) return my_open_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_open_fct_##A == 0) {           \
        my_open_fct_##A = (uintptr_t)fct; \
        return my_open_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_read_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_read_fct_##A == (uintptr_t)fct) return my_read_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_read_fct_##A == 0) {           \
        my_read_fct_##A = (uintptr_t)fct; \
        return my_read_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_write_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_write_fct_##A == (uintptr_t)fct) return my_write_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_write_fct_##A == 0) {           \
        my_write_fct_##A = (uintptr_t)fct; \
        return my_write_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_flush_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_flush_fct_##A == (uintptr_t)fct) return my_flush_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_flush_fct_##A == 0) {           \
        my_flush_fct_##A = (uintptr_t)fct; \
        return my_flush_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_release_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_release_fct_##A == (uintptr_t)fct) return my_release_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_release_fct_##A == 0) {           \
        my_release_fct_##A = (uintptr_t)fct; \
        return my_release_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fsync_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fsync_fct_##A == (uintptr_t)fct) return my_fsync_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_fsync_fct_##A == 0) {           \
        my_fsync_fct_##A = (uintptr_t)fct; \
        return my_fsync_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_opendir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_opendir_fct_##A == (uintptr_t)fct) return my_opendir_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_opendir_fct_##A == 0) {           \
        my_opendir_fct_##A = (uintptr_t)fct; \
        return my_opendir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_readdir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_readdir_fct_##A == (uintptr_t)fct) return my_readdir_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_readdir_fct_##A == 0) {           \
        my_readdir_fct_##A = (uintptr_t)fct; \
        return my_readdir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_releasedir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_releasedir_fct_##A == (uintptr_t)fct) return my_releasedir_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_releasedir_fct_##A == 0) {           \
        my_releasedir_fct_##A = (uintptr_t)fct; \
        return my_releasedir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fsyncdir_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fsyncdir_fct_##A == (uintptr_t)fct) return my_fsyncdir_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_fsyncdir_fct_##A == 0) {           \
        my_fsyncdir_fct_##A = (uintptr_t)fct; \
        return my_fsyncdir_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_statfs_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_statfs_fct_##A == (uintptr_t)fct) return my_statfs_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_statfs_fct_##A == 0) {           \
        my_statfs_fct_##A = (uintptr_t)fct; \
        return my_statfs_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_setxattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_setxattr_fct_##A == (uintptr_t)fct) return my_setxattr_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_setxattr_fct_##A == 0) {           \
        my_setxattr_fct_##A = (uintptr_t)fct; \
        return my_setxattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getxattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getxattr_fct_##A == (uintptr_t)fct) return my_getxattr_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_getxattr_fct_##A == 0) {           \
        my_getxattr_fct_##A = (uintptr_t)fct; \
        return my_getxattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_listxattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_listxattr_fct_##A == (uintptr_t)fct) return my_listxattr_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_listxattr_fct_##A == 0) {           \
        my_listxattr_fct_##A = (uintptr_t)fct; \
        return my_listxattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_removexattr_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_removexattr_fct_##A == (uintptr_t)fct) return my_removexattr_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_removexattr_fct_##A == 0) {           \
        my_removexattr_fct_##A = (uintptr_t)fct; \
        return my_removexattr_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_access_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_access_fct_##A == (uintptr_t)fct) return my_access_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_access_fct_##A == 0) {           \
        my_access_fct_##A = (uintptr_t)fct; \
        return my_access_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_create_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_create_fct_##A == (uintptr_t)fct) return my_create_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_create_fct_##A == 0) {           \
        my_create_fct_##A = (uintptr_t)fct; \
        return my_create_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getlk_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getlk_fct_##A == (uintptr_t)fct) return my_getlk_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_getlk_fct_##A == 0) {           \
        my_getlk_fct_##A = (uintptr_t)fct; \
        return my_getlk_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_setlk_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_setlk_fct_##A == (uintptr_t)fct) return my_setlk_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_setlk_fct_##A == 0) {           \
        my_setlk_fct_##A = (uintptr_t)fct; \
        return my_setlk_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_bmap_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_bmap_fct_##A == (uintptr_t)fct) return my_bmap_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_bmap_fct_##A == 0) {           \
        my_bmap_fct_##A = (uintptr_t)fct; \
        return my_bmap_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ioctl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ioctl_fct_##A == (uintptr_t)fct) return my_ioctl_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_ioctl_fct_##A == 0) {           \
        my_ioctl_fct_##A = (uintptr_t)fct; \
        return my_ioctl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_write_buf_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_write_buf_fct_##A == (uintptr_t)fct) return my_write_buf_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_write_buf_fct_##A == 0) {           \
        my_write_buf_fct_##A = (uintptr_t)fct; \
        return my_write_buf_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_retrieve_reply_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_retrieve_reply_fct_##A == (uintptr_t)fct) return my_retrieve_reply_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_retrieve_reply_fct_##A == 0) {           \
        my_retrieve_reply_fct_##A = (uintptr_t)fct; \
        return my_retrieve_reply_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_forget_multi_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_forget_multi_fct_##A == (uintptr_t)fct) return my_forget_multi_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_forget_multi_fct_##A == 0) {           \
        my_forget_multi_fct_##A = (uintptr_t)fct; \
        return my_forget_multi_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_flock_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_flock_fct_##A == (uintptr_t)fct) return my_flock_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_flock_fct_##A == 0) {           \
        my_flock_fct_##A = (uintptr_t)fct; \
        return my_flock_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fallocate_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fallocate_fct_##A == (uintptr_t)fct) return my_fallocate_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_fallocate_fct_##A == 0) {           \
        my_fallocate_fct_##A = (uintptr_t)fct; \
        return my_fallocate_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getattr_op_fct_##A == (uintptr_t)fct) return my_getattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_getattr_op_fct_##A == 0) {           \
        my_getattr_op_fct_##A = (uintptr_t)fct; \
        return my_getattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_readlink_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_readlink_op_fct_##A == (uintptr_t)fct) return my_readlink_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_readlink_op_fct_##A == 0) {           \
        my_readlink_op_fct_##A = (uintptr_t)fct; \
        return my_readlink_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getdir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getdir_op_fct_##A == (uintptr_t)fct) return my_getdir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_getdir_op_fct_##A == 0) {           \
        my_getdir_op_fct_##A = (uintptr_t)fct; \
        return my_getdir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_mknod_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_mknod_op_fct_##A == (uintptr_t)fct) return my_mknod_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_mknod_op_fct_##A == 0) {           \
        my_mknod_op_fct_##A = (uintptr_t)fct; \
        return my_mknod_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_mkdir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_mkdir_op_fct_##A == (uintptr_t)fct) return my_mkdir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_mkdir_op_fct_##A == 0) {           \
        my_mkdir_op_fct_##A = (uintptr_t)fct; \
        return my_mkdir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_unlink_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_unlink_op_fct_##A == (uintptr_t)fct) return my_unlink_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_unlink_op_fct_##A == 0) {           \
        my_unlink_op_fct_##A = (uintptr_t)fct; \
        return my_unlink_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_rmdir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_rmdir_op_fct_##A == (uintptr_t)fct) return my_rmdir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_rmdir_op_fct_##A == 0) {           \
        my_rmdir_op_fct_##A = (uintptr_t)fct; \
        return my_rmdir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_symlink_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_symlink_op_fct_##A == (uintptr_t)fct) return my_symlink_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_symlink_op_fct_##A == 0) {           \
        my_symlink_op_fct_##A = (uintptr_t)fct; \
        return my_symlink_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_rename_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_rename_op_fct_##A == (uintptr_t)fct) return my_rename_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_rename_op_fct_##A == 0) {           \
        my_rename_op_fct_##A = (uintptr_t)fct; \
        return my_rename_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_link_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_link_op_fct_##A == (uintptr_t)fct) return my_link_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_link_op_fct_##A == 0) {           \
        my_link_op_fct_##A = (uintptr_t)fct; \
        return my_link_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_chmod_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_chmod_op_fct_##A == (uintptr_t)fct) return my_chmod_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_chmod_op_fct_##A == 0) {           \
        my_chmod_op_fct_##A = (uintptr_t)fct; \
        return my_chmod_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_chown_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_chown_op_fct_##A == (uintptr_t)fct) return my_chown_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_chown_op_fct_##A == 0) {           \
        my_chown_op_fct_##A = (uintptr_t)fct; \
        return my_chown_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_truncate_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_truncate_op_fct_##A == (uintptr_t)fct) return my_truncate_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_truncate_op_fct_##A == 0) {           \
        my_truncate_op_fct_##A = (uintptr_t)fct; \
        return my_truncate_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_utime_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_utime_op_fct_##A == (uintptr_t)fct) return my_utime_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_utime_op_fct_##A == 0) {           \
        my_utime_op_fct_##A = (uintptr_t)fct; \
        return my_utime_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_open_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_open_op_fct_##A == (uintptr_t)fct) return my_open_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_open_op_fct_##A == 0) {           \
        my_open_op_fct_##A = (uintptr_t)fct; \
        return my_open_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_read_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_read_op_fct_##A == (uintptr_t)fct) return my_read_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_read_op_fct_##A == 0) {           \
        my_read_op_fct_##A = (uintptr_t)fct; \
        return my_read_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_write_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_write_op_fct_##A == (uintptr_t)fct) return my_write_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_write_op_fct_##A == 0) {           \
        my_write_op_fct_##A = (uintptr_t)fct; \
        return my_write_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_statfs_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_statfs_op_fct_##A == (uintptr_t)fct) return my_statfs_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_statfs_op_fct_##A == 0) {           \
        my_statfs_op_fct_##A = (uintptr_t)fct; \
        return my_statfs_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_flush_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_flush_op_fct_##A == (uintptr_t)fct) return my_flush_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_flush_op_fct_##A == 0) {           \
        my_flush_op_fct_##A = (uintptr_t)fct; \
        return my_flush_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_release_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_release_op_fct_##A == (uintptr_t)fct) return my_release_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_release_op_fct_##A == 0) {           \
        my_release_op_fct_##A = (uintptr_t)fct; \
        return my_release_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fsync_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fsync_op_fct_##A == (uintptr_t)fct) return my_fsync_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_fsync_op_fct_##A == 0) {           \
        my_fsync_op_fct_##A = (uintptr_t)fct; \
        return my_fsync_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_setxattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_setxattr_op_fct_##A == (uintptr_t)fct) return my_setxattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_setxattr_op_fct_##A == 0) {           \
        my_setxattr_op_fct_##A = (uintptr_t)fct; \
        return my_setxattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getxattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getxattr_op_fct_##A == (uintptr_t)fct) return my_getxattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_getxattr_op_fct_##A == 0) {           \
        my_getxattr_op_fct_##A = (uintptr_t)fct; \
        return my_getxattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_listxattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_listxattr_op_fct_##A == (uintptr_t)fct) return my_listxattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_listxattr_op_fct_##A == 0) {           \
        my_listxattr_op_fct_##A = (uintptr_t)fct; \
        return my_listxattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_removexattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_removexattr_op_fct_##A == (uintptr_t)fct) return my_removexattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_removexattr_op_fct_##A == 0) {           \
        my_removexattr_op_fct_##A = (uintptr_t)fct; \
        return my_removexattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_opendir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_opendir_op_fct_##A == (uintptr_t)fct) return my_opendir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_opendir_op_fct_##A == 0) {           \
        my_opendir_op_fct_##A = (uintptr_t)fct; \
        return my_opendir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_readdir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_readdir_op_fct_##A == (uintptr_t)fct) return my_readdir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_readdir_op_fct_##A == 0) {           \
        my_readdir_op_fct_##A = (uintptr_t)fct; \
        return my_readdir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_releasedir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_releasedir_op_fct_##A == (uintptr_t)fct) return my_releasedir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_releasedir_op_fct_##A == 0) {           \
        my_releasedir_op_fct_##A = (uintptr_t)fct; \
        return my_releasedir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fsyncdir_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fsyncdir_op_fct_##A == (uintptr_t)fct) return my_fsyncdir_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_fsyncdir_op_fct_##A == 0) {           \
        my_fsyncdir_op_fct_##A = (uintptr_t)fct; \
        return my_fsyncdir_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_init_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_init_op_fct_##A == (uintptr_t)fct) return my_init_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_init_op_fct_##A == 0) {           \
        my_init_op_fct_##A = (uintptr_t)fct; \
        return my_init_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_destroy_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_destroy_op_fct_##A == (uintptr_t)fct) return my_destroy_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_destroy_op_fct_##A == 0) {           \
        my_destroy_op_fct_##A = (uintptr_t)fct; \
        return my_destroy_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_access_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_access_op_fct_##A == (uintptr_t)fct) return my_access_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_access_op_fct_##A == 0) {           \
        my_access_op_fct_##A = (uintptr_t)fct; \
        return my_access_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_create_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_create_op_fct_##A == (uintptr_t)fct) return my_create_op_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_create_op_fct_##A == 0) {           \
        my_create_op_fct_##A = (uintptr_t)fct; \
        return my_create_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ftruncate_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ftruncate_op_fct_##A == (uintptr_t)fct) return my_ftruncate_op_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_ftruncate_op_fct_##A == 0) {           \
        my_ftruncate_op_fct_##A = (uintptr_t)fct; \
        return my_ftruncate_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fgetattr_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fgetattr_op_fct_##A == (uintptr_t)fct) return my_fgetattr_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_fgetattr_op_fct_##A == 0) {           \
        my_fgetattr_op_fct_##A = (uintptr_t)fct; \
        return my_fgetattr_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_lock_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_lock_op_fct_##A == (uintptr_t)fct) return my_lock_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_lock_op_fct_##A == 0) {           \
        my_lock_op_fct_##A = (uintptr_t)fct; \
        return my_lock_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_utimens_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_utimens_op_fct_##A == (uintptr_t)fct) return my_utimens_op_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_utimens_op_fct_##A == 0) {           \
        my_utimens_op_fct_##A = (uintptr_t)fct; \
        return my_utimens_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_bmap_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_bmap_op_fct_##A == (uintptr_t)fct) return my_bmap_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_bmap_op_fct_##A == 0) {           \
        my_bmap_op_fct_##A = (uintptr_t)fct; \
        return my_bmap_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ioctl_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ioctl_op_fct_##A == (uintptr_t)fct) return my_ioctl_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_ioctl_op_fct_##A == 0) {           \
        my_ioctl_op_fct_##A = (uintptr_t)fct; \
        return my_ioctl_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_poll_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_poll_op_fct_##A == (uintptr_t)fct) return my_poll_op_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_poll_op_fct_##A == 0) {           \
        my_poll_op_fct_##A = (uintptr_t)fct; \
        return my_poll_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_write_buf_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_write_buf_op_fct_##A == (uintptr_t)fct) return my_write_buf_op_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_write_buf_op_fct_##A == 0) {           \
        my_write_buf_op_fct_##A = (uintptr_t)fct; \
        return my_write_buf_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_read_buf_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_read_buf_op_fct_##A == (uintptr_t)fct) return my_read_buf_op_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_read_buf_op_fct_##A == 0) {           \
        my_read_buf_op_fct_##A = (uintptr_t)fct; \
        return my_read_buf_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_flock_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_flock_op_fct_##A == (uintptr_t)fct) return my_flock_op_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_flock_op_fct_##A == 0) {           \
        my_flock_op_fct_##A = (uintptr_t)fct; \
        return my_flock_op_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fallocate_op_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fallocate_op_fct_##A == (uintptr_t)fct) return my_fallocate_op_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_fallocate_op_fct_##A == 0) {           \
        my_fallocate_op_fct_##A = (uintptr_t)fct; \
        return my_fallocate_op_##A;               \
    }
    SUPER()
#undef GO
...
#define GO(A)                                                         \
    if (cvt < sz) {                                                   \
        o_.A = find_##A##_Fct(o->A);                                  \
        cvt += sizeof(void*);                                         \
        if (o_.A) printf_log(LOG_DEBUG, "fuse: %s is present\n", #A); \
    }
    GO(init)
    GO(destroy)
    GO(lookup)
