...
#define GO(A) \
    if (my_read_write_fct_##A == (uintptr_t)fct) return my_read_write_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_read_write_fct_##A == 0) {           \
        my_read_write_fct_##A = (uintptr_t)fct; \
        return my_read_write_##A;               \
    }
    SUPER()
#undef GO
...
static void* findclose_eofFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_close_eof_fct_##A == (uintptr_t)fct) return my_close_eof_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_close_eof_fct_##A == 0) {           \
        my_close_eof_fct_##A = (uintptr_t)fct; \
        return my_close_eof_##A;               \
    }
    SUPER()
#undef GO
...
static void* findtellFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_tell_fct_##A == (uintptr_t)fct) return my_tell_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_tell_fct_##A == 0) {           \
        my_tell_fct_##A = (uintptr_t)fct; \
        return my_tell_##A;               \
    }
    SUPER()
#undef GO
...
static void* findLengthFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_Length_fct_##A == (uintptr_t)fct) return my_Length_##A;
    SUPER()
#undef GO
#define GO(A)                               \
    if (my_Length_fct_##A == 0) {           \
        my_Length_fct_##A = (uintptr_t)fct; \
        return my_Length_##A;               \
    }
    SUPER()
#undef GO
...
static void* findEofFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_Eof_fct_##A == (uintptr_t)fct) return my_Eof_##A;
    SUPER()
#undef GO
#define GO(A)                            \
    if (my_Eof_fct_##A == 0) {           \
        my_Eof_fct_##A = (uintptr_t)fct; \
        return my_Eof_##A;               \
    }
    SUPER()
#undef GO
...
static void* findMetadataFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_Metadata_fct_##A == (uintptr_t)fct) return my_Metadata_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_Metadata_fct_##A == 0) {           \
        my_Metadata_fct_##A = (uintptr_t)fct; \
        return my_Metadata_##A;               \
    }
    SUPER()
#undef GO
