...
GOWM(fts64_children, pFEpi)
GOWM(fts64_close, iFEp)
GOWM(fts64_open, pFEpip)
GOWM(fts64_read, pFEp)
GOWM(fts64_set, iFEppi)
GOM(fts_children, pFEipi)
GOM(fts_close, iFEp)
GOM(fts_open, pFEpip)
GOM(fts_read, pFEp)
GOM(fts_set, iFEppi)
...
GOM(__getpagesize, iFEv)
GOWM(getpagesize, iFEv)
GO(getpass, pFp)
...
GO(getresgid, iFppp)
GO(getresuid, iFppp)
GOM(__getrlimit, iFEip)
GOWM(getrlimit, iFEup)
GOWM(getrlimit64, iFEup)
GO(getrpcbyname, pFp)
