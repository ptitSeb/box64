...
GO(XRecordQueryVersion, iFppp)
GO(XRecordRegisterClients, iFpLipipi)
GO(XRecordUnregisterClients, iFpLpi)
GO(XTestCompareCurrentCursorWithWindow, iFpL)
GO(XTestCompareCursorWithWindow, iFpLL)
GO(XTestDiscard, iFp)
...
GO(XTestFakeRelativeMotionEvent, iFpiiL)
GO(XTestGrabControl, iFpi)
GO(XTestQueryExtension, iFppppp)
GO(XTestSetGContextOfGC, vFpL)
GO(XTestSetVisualIDOfVisual, vFpL)
