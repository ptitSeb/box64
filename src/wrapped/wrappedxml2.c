...
#define GO(A) \
    if (my_xmlHashCopier_fct_##A == (uintptr_t)fct) return my_xmlHashCopier_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_xmlHashCopier_fct_##A == 0) {           \
        my_xmlHashCopier_fct_##A = (uintptr_t)fct; \
        return my_xmlHashCopier_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlHashDeallocator_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlHashDeallocator_fct_##A == (uintptr_t)fct) return my_xmlHashDeallocator_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_xmlHashDeallocator_fct_##A == 0) {           \
        my_xmlHashDeallocator_fct_##A = (uintptr_t)fct; \
        return my_xmlHashDeallocator_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlHashScanner_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlHashScanner_fct_##A == (uintptr_t)fct) return my_xmlHashScanner_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_xmlHashScanner_fct_##A == 0) {           \
        my_xmlHashScanner_fct_##A = (uintptr_t)fct; \
        return my_xmlHashScanner_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlHashScannerFull_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlHashScannerFull_fct_##A == (uintptr_t)fct) return my_xmlHashScannerFull_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_xmlHashScannerFull_fct_##A == 0) {           \
        my_xmlHashScannerFull_fct_##A = (uintptr_t)fct; \
        return my_xmlHashScannerFull_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlCharEncodingInputFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlCharEncodingInputFunc_fct_##A == (uintptr_t)fct) return my_xmlCharEncodingInputFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                 \
    if (my_xmlCharEncodingInputFunc_fct_##A == 0) {           \
        my_xmlCharEncodingInputFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlCharEncodingInputFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlCharEncodingOutputFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlCharEncodingOutputFunc_fct_##A == (uintptr_t)fct) return my_xmlCharEncodingOutputFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                  \
    if (my_xmlCharEncodingOutputFunc_fct_##A == 0) {           \
        my_xmlCharEncodingOutputFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlCharEncodingOutputFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlOutputWriteCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlOutputWriteCallback_fct_##A == (uintptr_t)fct) return my_xmlOutputWriteCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_xmlOutputWriteCallback_fct_##A == 0) {           \
        my_xmlOutputWriteCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlOutputWriteCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlOutputCloseCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlOutputCloseCallback_fct_##A == (uintptr_t)fct) return my_xmlOutputCloseCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_xmlOutputCloseCallback_fct_##A == 0) {           \
        my_xmlOutputCloseCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlOutputCloseCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlInputMatchCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlInputMatchCallback_fct_##A == (uintptr_t)fct) return my_xmlInputMatchCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_xmlInputMatchCallback_fct_##A == 0) {           \
        my_xmlInputMatchCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlInputMatchCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlInputOpenCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlInputOpenCallback_fct_##A == (uintptr_t)fct) return my_xmlInputOpenCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_xmlInputOpenCallback_fct_##A == 0) {           \
        my_xmlInputOpenCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlInputOpenCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlInputReadCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlInputReadCallback_fct_##A == (uintptr_t)fct) return my_xmlInputReadCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_xmlInputReadCallback_fct_##A == 0) {           \
        my_xmlInputReadCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlInputReadCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlInputCloseCallback_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlInputCloseCallback_fct_##A == (uintptr_t)fct) return my_xmlInputCloseCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_xmlInputCloseCallback_fct_##A == 0) {           \
        my_xmlInputCloseCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlInputCloseCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlSchemaValidityErrorFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlSchemaValidityErrorFunc_fct_##A == (uintptr_t)fct) return my_xmlSchemaValidityErrorFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                   \
    if (my_xmlSchemaValidityErrorFunc_fct_##A == 0) {           \
        my_xmlSchemaValidityErrorFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlSchemaValidityErrorFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlSchemaValidityWarningFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlSchemaValidityWarningFunc_fct_##A == (uintptr_t)fct) return my_xmlSchemaValidityWarningFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                     \
    if (my_xmlSchemaValidityWarningFunc_fct_##A == 0) {           \
        my_xmlSchemaValidityWarningFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlSchemaValidityWarningFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_internalSubsetSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_internalSubsetSAXFunc_fct_##A == (uintptr_t)fct) return my_internalSubsetSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_internalSubsetSAXFunc_fct_##A == 0) {           \
        my_internalSubsetSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_internalSubsetSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_isStandaloneSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_isStandaloneSAXFunc_fct_##A == (uintptr_t)fct) return my_isStandaloneSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_isStandaloneSAXFunc_fct_##A == 0) {           \
        my_isStandaloneSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_isStandaloneSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_hasInternalSubsetSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_hasInternalSubsetSAXFunc_fct_##A == (uintptr_t)fct) return my_hasInternalSubsetSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                 \
    if (my_hasInternalSubsetSAXFunc_fct_##A == 0) {           \
        my_hasInternalSubsetSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_hasInternalSubsetSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_hasExternalSubsetSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_hasExternalSubsetSAXFunc_fct_##A == (uintptr_t)fct) return my_hasExternalSubsetSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                 \
    if (my_hasExternalSubsetSAXFunc_fct_##A == 0) {           \
        my_hasExternalSubsetSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_hasExternalSubsetSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_resolveEntitySAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_resolveEntitySAXFunc_fct_##A == (uintptr_t)fct) return my_resolveEntitySAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_resolveEntitySAXFunc_fct_##A == 0) {           \
        my_resolveEntitySAXFunc_fct_##A = (uintptr_t)fct; \
        return my_resolveEntitySAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getEntitySAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getEntitySAXFunc_fct_##A == (uintptr_t)fct) return my_getEntitySAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_getEntitySAXFunc_fct_##A == 0) {           \
        my_getEntitySAXFunc_fct_##A = (uintptr_t)fct; \
        return my_getEntitySAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_entityDeclSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_entityDeclSAXFunc_fct_##A == (uintptr_t)fct) return my_entityDeclSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_entityDeclSAXFunc_fct_##A == 0) {           \
        my_entityDeclSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_entityDeclSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_notationDeclSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_notationDeclSAXFunc_fct_##A == (uintptr_t)fct) return my_notationDeclSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_notationDeclSAXFunc_fct_##A == 0) {           \
        my_notationDeclSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_notationDeclSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_attributeDeclSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_attributeDeclSAXFunc_fct_##A == (uintptr_t)fct) return my_attributeDeclSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_attributeDeclSAXFunc_fct_##A == 0) {           \
        my_attributeDeclSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_attributeDeclSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_elementDeclSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_elementDeclSAXFunc_fct_##A == (uintptr_t)fct) return my_elementDeclSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_elementDeclSAXFunc_fct_##A == 0) {           \
        my_elementDeclSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_elementDeclSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_unparsedEntityDeclSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_unparsedEntityDeclSAXFunc_fct_##A == (uintptr_t)fct) return my_unparsedEntityDeclSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                  \
    if (my_unparsedEntityDeclSAXFunc_fct_##A == 0) {           \
        my_unparsedEntityDeclSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_unparsedEntityDeclSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_setDocumentLocatorSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_setDocumentLocatorSAXFunc_fct_##A == (uintptr_t)fct) return my_setDocumentLocatorSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                  \
    if (my_setDocumentLocatorSAXFunc_fct_##A == 0) {           \
        my_setDocumentLocatorSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_setDocumentLocatorSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_startDocumentSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_startDocumentSAXFunc_fct_##A == (uintptr_t)fct) return my_startDocumentSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_startDocumentSAXFunc_fct_##A == 0) {           \
        my_startDocumentSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_startDocumentSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_endDocumentSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_endDocumentSAXFunc_fct_##A == (uintptr_t)fct) return my_endDocumentSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_endDocumentSAXFunc_fct_##A == 0) {           \
        my_endDocumentSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_endDocumentSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_startElementSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_startElementSAXFunc_fct_##A == (uintptr_t)fct) return my_startElementSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_startElementSAXFunc_fct_##A == 0) {           \
        my_startElementSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_startElementSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_endElementSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_endElementSAXFunc_fct_##A == (uintptr_t)fct) return my_endElementSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_endElementSAXFunc_fct_##A == 0) {           \
        my_endElementSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_endElementSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_referenceSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_referenceSAXFunc_fct_##A == (uintptr_t)fct) return my_referenceSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_referenceSAXFunc_fct_##A == 0) {           \
        my_referenceSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_referenceSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_charactersSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_charactersSAXFunc_fct_##A == (uintptr_t)fct) return my_charactersSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_charactersSAXFunc_fct_##A == 0) {           \
        my_charactersSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_charactersSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ignorableWhitespaceSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ignorableWhitespaceSAXFunc_fct_##A == (uintptr_t)fct) return my_ignorableWhitespaceSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                   \
    if (my_ignorableWhitespaceSAXFunc_fct_##A == 0) {           \
        my_ignorableWhitespaceSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_ignorableWhitespaceSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_processingInstructionSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_processingInstructionSAXFunc_fct_##A == (uintptr_t)fct) return my_processingInstructionSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                     \
    if (my_processingInstructionSAXFunc_fct_##A == 0) {           \
        my_processingInstructionSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_processingInstructionSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_commentSAXFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_commentSAXFunc_fct_##A == (uintptr_t)fct) return my_commentSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_commentSAXFunc_fct_##A == 0) {           \
        my_commentSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_commentSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_warningSAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_warningSAXFunc_fct_##A == (uintptr_t)fct) return my_warningSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_warningSAXFunc_fct_##A == 0) {           \
        my_warningSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_warningSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_errorSAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_errorSAXFunc_fct_##A == (uintptr_t)fct) return my_errorSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_errorSAXFunc_fct_##A == 0) {           \
        my_errorSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_errorSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_fatalErrorSAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_fatalErrorSAXFunc_fct_##A == (uintptr_t)fct) return my_fatalErrorSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_fatalErrorSAXFunc_fct_##A == 0) {           \
        my_fatalErrorSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_fatalErrorSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_getParameterEntitySAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_getParameterEntitySAXFunc_fct_##A == (uintptr_t)fct) return my_getParameterEntitySAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                                  \
    if (my_getParameterEntitySAXFunc_fct_##A == 0) {           \
        my_getParameterEntitySAXFunc_fct_##A = (uintptr_t)fct; \
        return my_getParameterEntitySAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_cdataBlockSAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_cdataBlockSAXFunc_fct_##A == (uintptr_t)fct) return my_cdataBlockSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_cdataBlockSAXFunc_fct_##A == 0) {           \
        my_cdataBlockSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_cdataBlockSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_externalSubsetSAXFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_externalSubsetSAXFunc_fct_##A == (uintptr_t)fct) return my_externalSubsetSAXFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_externalSubsetSAXFunc_fct_##A == 0) {           \
        my_externalSubsetSAXFunc_fct_##A = (uintptr_t)fct; \
        return my_externalSubsetSAXFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlSAX2StartElementNs_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlSAX2StartElementNs_fct_##A == (uintptr_t)fct) return my_xmlSAX2StartElementNs_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_xmlSAX2StartElementNs_fct_##A == 0) {           \
        my_xmlSAX2StartElementNs_fct_##A = (uintptr_t)fct; \
        return my_xmlSAX2StartElementNs_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlSAX2EndElementNs_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlSAX2EndElementNs_fct_##A == (uintptr_t)fct) return my_xmlSAX2EndElementNs_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_xmlSAX2EndElementNs_fct_##A == 0) {           \
        my_xmlSAX2EndElementNs_fct_##A = (uintptr_t)fct; \
        return my_xmlSAX2EndElementNs_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlExternalEntityLoaderFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlExternalEntityLoader_fct_##A == (uintptr_t)fct) return my_xmlExternalEntityLoader_##A;
    SUPER()
#undef GO
#define GO(A)                                                \
    if (my_xmlExternalEntityLoader_fct_##A == 0) {           \
        my_xmlExternalEntityLoader_fct_##A = (uintptr_t)fct; \
        return my_xmlExternalEntityLoader_##A;               \
    }
    SUPER()
#undef GO
...
#define GO(A) \
    if (my_xmlExternalEntityLoader_##A == fct) return (void*)my_xmlExternalEntityLoader_fct_##A;
    SUPER()
#undef GO
...
static void* find_xmlGenericErrorFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlGenericErrorFunc_fct_##A == (uintptr_t)fct) return my_xmlGenericErrorFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_xmlGenericErrorFunc_fct_##A == 0) {           \
        my_xmlGenericErrorFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlGenericErrorFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_xmlGenericErrorFunc_Fct(void* fct)
{
    ...
    if (CheckBridged(my_lib->w.bridge, fct))
        return (void*)CheckBridged(my_lib->w.bridge, fct);
#define GO(A) \
    if (my_xmlGenericErrorFunc_##A == fct) return (void*)my_xmlGenericErrorFunc_fct_##A;
    SUPER()
#undef GO
...
static void* find_xmlStructuredErrorFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlStructuredErrorFunc_fct_##A == (uintptr_t)fct) return my_xmlStructuredErrorFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_xmlStructuredErrorFunc_fct_##A == 0) {           \
        my_xmlStructuredErrorFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlStructuredErrorFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_xmlStructuredErrorFunc_Fct(void* fct)
{
    ...
    if (CheckBridged(my_lib->w.bridge, fct))
        return (void*)CheckBridged(my_lib->w.bridge, fct);
#define GO(A) \
    if (my_xmlStructuredErrorFunc_##A == fct) return (void*)my_xmlStructuredErrorFunc_fct_##A;
    SUPER()
#undef GO
...
static void* find_xmlOutputMatchCallback_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlOutputMatchCallback_fct_##A == (uintptr_t)fct) return my_xmlOutputMatchCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_xmlOutputMatchCallback_fct_##A == 0) {           \
        my_xmlOutputMatchCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlOutputMatchCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlOutputOpenCallback_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlOutputOpenCallback_fct_##A == (uintptr_t)fct) return my_xmlOutputOpenCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_xmlOutputOpenCallback_fct_##A == 0) {           \
        my_xmlOutputOpenCallback_fct_##A = (uintptr_t)fct; \
        return my_xmlOutputOpenCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xmlTextReaderErrorFunc_Fct(void* fct) // this one have a VAArg
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xmlTextReaderErrorFunc_fct_##A == (uintptr_t)fct) return my_xmlTextReaderErrorFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_xmlTextReaderErrorFunc_fct_##A == 0) {           \
        my_xmlTextReaderErrorFunc_fct_##A = (uintptr_t)fct; \
        return my_xmlTextReaderErrorFunc_##A;               \
    }
    SUPER()
#undef GO
