...
#define GO(A) \
    if (my_sbi_setup_fct_##A == (uintptr_t)fct) return my_sbi_setup_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_sbi_setup_fct_##A == 0) {           \
        my_sbi_setup_fct_##A = (uintptr_t)fct; \
        return my_sbi_setup_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sbi_remove_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sbi_remove_fct_##A == (uintptr_t)fct) return my_sbi_remove_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_sbi_remove_fct_##A == 0) {           \
        my_sbi_remove_fct_##A = (uintptr_t)fct; \
        return my_sbi_remove_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sbi_ctrl_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sbi_ctrl_fct_##A == (uintptr_t)fct) return my_sbi_ctrl_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_sbi_ctrl_fct_##A == 0) {           \
        my_sbi_ctrl_fct_##A = (uintptr_t)fct; \
        return my_sbi_ctrl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sbi_read_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sbi_read_fct_##A == (uintptr_t)fct) return my_sbi_read_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_sbi_read_fct_##A == 0) {           \
        my_sbi_read_fct_##A = (uintptr_t)fct; \
        return my_sbi_read_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sbi_write_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sbi_write_fct_##A == (uintptr_t)fct) return my_sbi_write_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_sbi_write_fct_##A == 0) {           \
        my_sbi_write_fct_##A = (uintptr_t)fct; \
        return my_sbi_write_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sbi_close_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sbi_close_fct_##A == (uintptr_t)fct) return my_sbi_close_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_sbi_close_fct_##A == 0) {           \
        my_sbi_close_fct_##A = (uintptr_t)fct; \
        return my_sbi_close_##A;               \
    }
    SUPER()
#undef GO
