...
#define GO(A) \
    if (my_getprocaddress_platform_##A == key) return my_getprocaddress_with_platform_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_getprocaddress_platform_##A == 0) {      \
        my_getprocaddress_platform_##A = key;       \
        return my_getprocaddress_with_platform_##A; \
    }
    SUPER()
#undef GO
...
{
#define GO(A) \
    if (my_getprocaddress_api_##A == api) return my_getprocaddress_with_api_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_getprocaddress_api_##A == 0) {      \
        my_getprocaddress_api_##A = api;       \
        return my_getprocaddress_with_api_##A; \
    }
    SUPER()
#undef GO
...
#define GO(A) \
    if (my_GstGLContextThreadFunc_fct_##A == (uintptr_t)fct) return my_GstGLContextThreadFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_GstGLContextThreadFunc_fct_##A == 0) {           \
        my_GstGLContextThreadFunc_fct_##A = (uintptr_t)fct; \
        return my_GstGLContextThreadFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstGLFilterRenderFuncFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_GstGLFilterRenderFunc_fct_##A == (uintptr_t)fct) return my_GstGLFilterRenderFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_GstGLFilterRenderFunc_fct_##A == 0) {           \
        my_GstGLFilterRenderFunc_fct_##A = (uintptr_t)fct; \
        return my_GstGLFilterRenderFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstGLFramebufferFuncFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_GstGLFramebufferFunc_fct_##A == (uintptr_t)fct) return my_GstGLFramebufferFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_GstGLFramebufferFunc_fct_##A == 0) {           \
        my_GstGLFramebufferFunc_fct_##A = (uintptr_t)fct; \
        return my_GstGLFramebufferFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstGLWindowCBFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_GstGLWindowCB_fct_##A == (uintptr_t)fct) return my_GstGLWindowCB_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_GstGLWindowCB_fct_##A == 0) {           \
        my_GstGLWindowCB_fct_##A = (uintptr_t)fct; \
        return my_GstGLWindowCB_##A;               \
    }
    SUPER()
#undef GO
