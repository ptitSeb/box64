...
#define GO(A) \
    if (my_async_fct_##A == (uintptr_t)fct) return my_async_##A;
    SUPER()
#undef GO
#define GO(A)                              \
    if (my_async_fct_##A == 0) {           \
        my_async_fct_##A = (uintptr_t)fct; \
        return my_async_##A;               \
    }
    SUPER()
#undef GO
...
static void* findElemFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_elem_fct_##A == (uintptr_t)fct) return my_elem_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_elem_fct_##A == 0) {           \
        my_elem_fct_##A = (uintptr_t)fct; \
        return my_elem_##A;               \
    }
    SUPER()
#undef GO
