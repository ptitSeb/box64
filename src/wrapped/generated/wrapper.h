...
void vFLpi(x64emu_t *emu, uintptr_t fnc);
...
void vFEpppL(x64emu_t *emu, uintptr_t fnc);
...
void LFppipLp(x64emu_t *emu, uintptr_t fnc);
...
void pFEpppuipppp(x64emu_t *emu, uintptr_t fnc);
...
void vFvLpi(x64emu_t *emu, uintptr_t fnc);
