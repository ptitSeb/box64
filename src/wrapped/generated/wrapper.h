...
void pFpiui(x64emu_t *emu, uintptr_t fnc);
...
void pFpiupL(x64emu_t *emu, uintptr_t fnc);
...
void pFpupuL(x64emu_t *emu, uintptr_t fnc);
...
void vFipippp(x64emu_t *emu, uintptr_t fnc);
...
void iFpiuipu(x64emu_t *emu, uintptr_t fnc);
...
void pFpiuipp(x64emu_t *emu, uintptr_t fnc);
...
void pFpuiipp(x64emu_t *emu, uintptr_t fnc);
void pFpuiuuu(x64emu_t *emu, uintptr_t fnc);
...
void pFpuupuL(x64emu_t *emu, uintptr_t fnc);
...
void pFppupLp(x64emu_t *emu, uintptr_t fnc);
...
void pFpppupu(x64emu_t *emu, uintptr_t fnc);
void pFpppupL(x64emu_t *emu, uintptr_t fnc);
...
void pFpppppL(x64emu_t *emu, uintptr_t fnc);
...
void vFippippp(x64emu_t *emu, uintptr_t fnc);
...
void iFpupupup(x64emu_t *emu, uintptr_t fnc);
...
void iFppupLip(x64emu_t *emu, uintptr_t fnc);
...
void pFpiiLppu(x64emu_t *emu, uintptr_t fnc);
...
void pFppupLip(x64emu_t *emu, uintptr_t fnc);
...
void iFpiuuuppp(x64emu_t *emu, uintptr_t fnc);
