...
#define SUPER() ADDED_FUNCTIONS() \
	...
	GO(fsconfig, iFiuppi_t) \
	GO(prctl, iFiLLLL_t) \
	GO(epoll_pwait, iFipiip_t) \
	GO(statx, iFipiup_t) \
	GO(move_mount, iFipipu_t) \
	GO(epoll_pwait2, iFipipp_t) \
	GO(mount_setattr, iFipupL_t) \
