...
GO(xcb_xinerama_is_active, pFpp)
GO(xcb_xinerama_is_active_reply, pFpup)
GO(xcb_xinerama_is_active_unchecked, pFpp)
GO(xcb_xinerama_query_screens, pFpp)
GO(xcb_xinerama_query_screens_reply, pFpup)
GO(xcb_xinerama_query_screens_screen_info, pFp)
GO(xcb_xinerama_query_screens_screen_info_iterator, pFpp)
GO(xcb_xinerama_query_screens_screen_info_length, iFp)
GO(xcb_xinerama_query_screens_sizeof, iFp)
GO(xcb_xinerama_query_screens_unchecked, pFpp)
