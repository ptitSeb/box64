...
GO(dbus_bus_get, pFup)
GO(dbus_bus_get_id, pFpp)
GO(dbus_bus_get_private, pFup)
GO(dbus_bus_get_unique_name, pFp)
GO(dbus_bus_get_unix_user, LFppp)
GO(dbus_bus_name_has_owner, uFppp)
GO(dbus_bus_register, uFpp)
...
GO(dbus_bus_start_service_by_name, uFppupp)
...
GO(dbus_connection_get_adt_audit_session_data, uFppp)
...
GO(dbus_connection_get_object_path_data, uFppp)
...
GO(dbus_connection_get_unix_process_id, uFpp)
GO(dbus_connection_get_unix_user, uFpp)
GO(dbus_connection_get_windows_user, uFpp)
GO(dbus_connection_has_messages_to_send, uFp)
GO(dbus_connection_list_registered, uFppp)
...
GOM(dbus_connection_register_fallback, uFEpppp)
GOM(dbus_connection_register_object_path, uFEpppp)
...
GO(dbus_connection_send_with_reply, uFpppi)
...
GOM(dbus_connection_try_register_fallback, uFEppppp)
GOM(dbus_connection_try_register_object_path, uFEppppp)
GO(dbus_connection_unref, vFp)
GO(dbus_connection_unregister_object_path, uFpp)
GO(dbus_error_free, vFp)
GO(dbus_error_has_name, uFpp)
GO(dbus_error_init, vFp)
GO(dbus_error_is_set, uFp)
GO(dbus_free, vFp)
...
GOM(dbus_message_append_args_valist, uFEpiA)
...
GOM(dbus_message_get_args, uFEppiV)
GO(dbus_message_get_allow_interactive_authorization, uFp)
GOM(dbus_message_get_args_valist, uFEppiA)
...
GO(dbus_message_get_path_decomposed, uFpp)
...
GO(dbus_message_iter_abandon_container_if_open, vFpp)
GO(dbus_message_iter_append_basic, uFpip)
GO(dbus_message_iter_append_fixed_array, uFpipi)
GO(dbus_message_iter_close_container, uFpp)
...
GO(dbus_message_iter_has_next, uFp)
GO(dbus_message_iter_init, uFpp)
GO(dbus_message_iter_init_append, vFpp)
GO(dbus_message_iter_next, uFp)
GO(dbus_message_iter_open_container, uFpipp)
GO(dbus_message_iter_recurse, vFpp)
GO(dbus_message_lock, vFp)
GO(dbus_message_marshal, uFppp)
...
GO(dbus_server_set_auth_mechanisms, uFpp)
...
//GOM(dbus_set_error, vFEpppV)
GO(dbus_set_error_const, vFppp)
GO(dbus_set_error_from_message, uFpp)
...
GO(dbus_signature_iter_next, uFp)
GO(dbus_signature_iter_recurse, vFpp)
GO(dbus_signature_validate, uFpp)
GO(dbus_signature_validate_single, uFpp)
//GOM(dbus_threads_init, uFEp)
...
GO(dbus_validate_bus_name, uFpp)
GO(dbus_validate_error_name, uFpp)
GO(dbus_validate_interface, uFpp)
GO(dbus_validate_member, uFpp)
GO(dbus_validate_path, uFpp)
GO(dbus_validate_utf8, uFpp)
