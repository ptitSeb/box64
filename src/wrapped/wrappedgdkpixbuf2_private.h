...
GO(gdk_colorspace_get_type, LFv)
GO(gdk_interp_type_get_type, LFv)
GO(gdk_pixbuf_add_alpha, pFpiCCC)
GO(gdk_pixbuf_alpha_mode_get_type, LFv)
...
GO(gdk_pixbuf_animation_iter_get_type, LFv)
GO(gdk_pixbuf_animation_iter_on_currently_loading_frame, iFp)
GO(gdk_pixbuf_animation_new_from_file, pFpp)
GO(gdk_pixbuf_animation_new_from_resource, pFpp)
GO(gdk_pixbuf_animation_new_from_stream, pFppp)
//GOM(gdk_pixbuf_animation_new_from_stream_async, vFEpppp)
GO(gdk_pixbuf_animation_new_from_stream_finish, pFpp)
...
GO(gdk_pixbuf_composite, vFppiiiiddddui)
GO(gdk_pixbuf_composite_color, vFppiiiidddduiiiiuu)
GO(gdk_pixbuf_composite_color_simple, pFpiiuiiuu)
GO(gdk_pixbuf_copy, pFp)
GO(gdk_pixbuf_copy_area, vFpiiiipii)
GO(gdk_pixbuf_error_get_type, LFv)
GO(gdk_pixbuf_error_quark, uFv)
...
GO(gdk_pixbuf_format_get_type, LFv)
...
GO(gdk_pixbuf_get_byte_length, LFp)
...
GO(gdk_pixbuf_loader_get_type, LFv)
...
GO(gdk_pixbuf_new, pFuiiii)
GO(gdk_pixbuf_new_from_bytes, pFpuiiiii)
GOM(gdk_pixbuf_new_from_data, pFEpuiiiiipp)
...
//GOM(gdk_pixbuf_new_from_stream_async, vFEpppp)
GO(gdk_pixbuf_new_from_stream_at_scale, pFpiiipp)
//GOM(gdk_pixbuf_new_from_stream_at_scale_async, vFEpiiippp)
GO(gdk_pixbuf_new_from_stream_finish, pFpp)
...
GO(gdk_pixbuf_read_pixels, pFp)
GO(gdk_pixbuf_ref, pFp)
GO(gdk_pixbuf_rotate_simple, pFpu)
...
GO(gdk_pixbuf_scaled_anim_get_type, LFv)
GO(gdk_pixbuf_scaled_anim_iter_get_type, LFv)
GO(gdk_pixbuf_scale_simple, pFpiiu)
GO(gdk_pixbuf_set_option, iFppp)
GO(gdk_pixbuf_simple_anim_add_frame, vFpp)
GO(gdk_pixbuf_simple_anim_get_loop, iFp)
GO(gdk_pixbuf_simple_anim_get_type, LFv)
GO(gdk_pixbuf_simple_anim_iter_get_type, LFv)
GO(gdk_pixbuf_simple_anim_new, pFiif)
GO(gdk_pixbuf_simple_anim_set_loop, vFpi)
GO(gdk_pixbuf_unref, vFp)
GO(gdk_pixdata_deserialize, iFpupp)
GO(gdk_pixdata_from_pixbuf, pFppi)
GO(gdk_pixdata_serialize, pFpp)
GO(gdk_pixdata_to_csource, pFppu)
