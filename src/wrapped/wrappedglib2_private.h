...
GOM(g_log_structured_standard, vFEpuppppV)
GO(g_lstat, iFpp)
...
GOM(g_markup_collect_attributes, iFEppppipV)
...
GOM(g_ptr_array_find_with_equal_func, iFEpppp)
...
GOM(g_ptr_array_sort_values, vFEpp)
...
GO(g_uri_get_host, pFp)
GO(g_uri_get_port, iFp)
GO(g_uri_get_scheme, pFp)
...
GO(g_variant_builder_init_static, vFpp)
