...
GO(xcb_present_notify_msc, UFbuuUUU)
//GO(xcb_present_notify_msc_checked, 
//GO(xcb_present_notify_next, 
GO(xcb_present_pixmap, UFbuuuuuwwuuuuUUUup)
GO(xcb_present_pixmap_checked, UFbuuuuuwwuuuuUUUup)
...
GO(xcb_present_query_version, UFbuu)
GO(xcb_present_query_version_reply, pFbup)
GO(xcb_present_query_version_unchecked, UFbuu)
...
GO(xcb_present_select_input, UFbuuu)
GO(xcb_present_select_input_checked, UFbuuu)
