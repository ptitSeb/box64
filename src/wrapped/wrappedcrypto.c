...
#define GO(A) \
    if (my_BIO_meth_set_write_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_write_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_BIO_meth_set_write_fct_##A == 0) {           \
        my_BIO_meth_set_write_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_write_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_read_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_read_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_read_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_BIO_meth_set_read_fct_##A == 0) {           \
        my_BIO_meth_set_read_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_read_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_puts_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_puts_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_puts_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_BIO_meth_set_puts_fct_##A == 0) {           \
        my_BIO_meth_set_puts_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_puts_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_gets_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_gets_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_gets_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_BIO_meth_set_gets_fct_##A == 0) {           \
        my_BIO_meth_set_gets_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_gets_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_ctrl_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_ctrl_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_ctrl_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_BIO_meth_set_ctrl_fct_##A == 0) {           \
        my_BIO_meth_set_ctrl_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_ctrl_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_create_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_create_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_create_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_BIO_meth_set_create_fct_##A == 0) {           \
        my_BIO_meth_set_create_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_create_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_BIO_meth_set_destroy_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_BIO_meth_set_destroy_fct_##A == (uintptr_t)fct) return my_BIO_meth_set_destroy_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_BIO_meth_set_destroy_fct_##A == 0) {           \
        my_BIO_meth_set_destroy_fct_##A = (uintptr_t)fct; \
        return my_BIO_meth_set_destroy_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ENGINE_ctrl_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_ENGINE_ctrl_cb_fct_##A == (uintptr_t)fct) return my_ENGINE_ctrl_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_ENGINE_ctrl_cb_fct_##A == 0) {           \
        my_ENGINE_ctrl_cb_fct_##A = (uintptr_t)fct; \
        return my_ENGINE_ctrl_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_cmp_fnc_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_cmp_fnc_fct_##A == (uintptr_t)fct) return my_cmp_fnc_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_cmp_fnc_fct_##A == 0) {           \
        my_cmp_fnc_fct_##A = (uintptr_t)fct; \
        return my_cmp_fnc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_free_fnc_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_free_fnc_fct_##A == (uintptr_t)fct) return my_free_fnc_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_free_fnc_fct_##A == 0) {           \
        my_free_fnc_fct_##A = (uintptr_t)fct; \
        return my_free_fnc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_id_func_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_id_func_fct_##A == (uintptr_t)fct) return my_id_func_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my_id_func_fct_##A == 0) {           \
        my_id_func_fct_##A = (uintptr_t)fct; \
        return my_id_func_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_lock_func_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_lock_func_fct_##A == (uintptr_t)fct) return my_lock_func_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_lock_func_fct_##A == 0) {           \
        my_lock_func_fct_##A = (uintptr_t)fct; \
        return my_lock_func_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_passphrase_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_passphrase_fct_##A == (uintptr_t)fct) return my_passphrase_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my_passphrase_fct_##A == 0) {           \
        my_passphrase_fct_##A = (uintptr_t)fct; \
        return my_passphrase_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_xnew_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_xnew_fct_##A == (uintptr_t)fct) return my_xnew_##A;
    SUPER()
#undef GO
#define GO(A)                             \
    if (my_xnew_fct_##A == 0) {           \
        my_xnew_fct_##A = (uintptr_t)fct; \
        return my_xnew_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_d2i_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_d2i_fct_##A == (uintptr_t)fct) return my_d2i_##A;
    SUPER()
#undef GO
#define GO(A)                            \
    if (my_d2i_fct_##A == 0) {           \
        my_d2i_fct_##A = (uintptr_t)fct; \
        return my_d2i_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_i2d_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_i2d_fct_##A == (uintptr_t)fct) return my_i2d_##A;
    SUPER()
#undef GO
#define GO(A)                            \
    if (my_i2d_fct_##A == 0) {           \
        my_i2d_fct_##A = (uintptr_t)fct; \
        return my_i2d_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_pem_password_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_pem_password_cb_fct_##A == (uintptr_t)fct) return my_pem_password_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my_pem_password_cb_fct_##A == 0) {           \
        my_pem_password_cb_fct_##A = (uintptr_t)fct; \
        return my_pem_password_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ctx_verify_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_ctx_verify_cb_fct_##A == (uintptr_t)fct) return my_ctx_verify_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_ctx_verify_cb_fct_##A == 0) {           \
        my_ctx_verify_cb_fct_##A = (uintptr_t)fct; \
        return my_ctx_verify_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_verify_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_verify_cb_fct_##A == (uintptr_t)fct) return my_verify_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_verify_cb_fct_##A == 0) {           \
        my_verify_cb_fct_##A = (uintptr_t)fct; \
        return my_verify_cb_##A;               \
    }
    SUPER()
#undef GO
