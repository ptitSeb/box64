...
#define GO(A) \
    if (my3_pem_passwd_cb_fct_##A == (uintptr_t)fct) return my3_pem_passwd_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my3_pem_passwd_cb_fct_##A == 0) {           \
        my3_pem_passwd_cb_fct_##A = (uintptr_t)fct; \
        return my3_pem_passwd_cb_##A;               \
    }
    SUPER()
#undef GO
...
#define GO(A) \
    if (my3_pem_passwd_cb_##A == fct) return (void*)my3_pem_passwd_cb_fct_##A;
    SUPER()
#undef GO
...
static void* find_anonymous_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_anonymous_fct_##A == (uintptr_t)fct) return my3_anonymous_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my3_anonymous_fct_##A == 0) {           \
        my3_anonymous_fct_##A = (uintptr_t)fct; \
        return my3_anonymous_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_verify_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_verify_fct_##A == (uintptr_t)fct) return my3_verify_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my3_verify_fct_##A == 0) {           \
        my3_verify_fct_##A = (uintptr_t)fct; \
        return my3_verify_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_verify_Fct(void* fct)
{
    ...
    if (CheckBridged(my_lib->w.bridge, fct))
        return (void*)CheckBridged(my_lib->w.bridge, fct);
#define GO(A) \
    if (my3_verify_##A == fct) return (void*)my3_verify_fct_##A;
    SUPER()
#undef GO
...
static void* find_ex_new_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_ex_new_fct_##A == (uintptr_t)fct) return my3_ex_new_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my3_ex_new_fct_##A == 0) {           \
        my3_ex_new_fct_##A = (uintptr_t)fct; \
        return my3_ex_new_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ex_free_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_ex_free_fct_##A == (uintptr_t)fct) return my3_ex_free_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my3_ex_free_fct_##A == 0) {           \
        my3_ex_free_fct_##A = (uintptr_t)fct; \
        return my3_ex_free_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_ex_dup_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_ex_dup_fct_##A == (uintptr_t)fct) return my3_ex_dup_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my3_ex_dup_fct_##A == 0) {           \
        my3_ex_dup_fct_##A = (uintptr_t)fct; \
        return my3_ex_dup_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_client_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_client_cb_fct_##A == (uintptr_t)fct) return my3_client_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my3_client_cb_fct_##A == 0) {           \
        my3_client_cb_fct_##A = (uintptr_t)fct; \
        return my3_client_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_proto_select_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_proto_select_fct_##A == (uintptr_t)fct) return my3_proto_select_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my3_proto_select_fct_##A == 0) {           \
        my3_proto_select_fct_##A = (uintptr_t)fct; \
        return my3_proto_select_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_client_cert_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_client_cert_fct_##A == (uintptr_t)fct) return my3_client_cert_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my3_client_cert_fct_##A == 0) {           \
        my3_client_cert_fct_##A = (uintptr_t)fct; \
        return my3_client_cert_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_alpn_select_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_alpn_select_cb_fct_##A == (uintptr_t)fct) return my3_alpn_select_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my3_alpn_select_cb_fct_##A == 0) {           \
        my3_alpn_select_cb_fct_##A = (uintptr_t)fct; \
        return my3_alpn_select_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_keylog_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_keylog_cb_fct_##A == (uintptr_t)fct) return my3_keylog_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                   \
    if (my3_keylog_cb_fct_##A == 0) {           \
        my3_keylog_cb_fct_##A = (uintptr_t)fct; \
        return my3_keylog_cb_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_msg_cb_Fct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my3_msg_cb_fct_##A == (uintptr_t)fct) return my3_msg_cb_##A;
    SUPER()
#undef GO
#define GO(A)                                \
    if (my3_msg_cb_fct_##A == 0) {           \
        my3_msg_cb_fct_##A = (uintptr_t)fct; \
        return my3_msg_cb_##A;               \
    }
    SUPER()
#undef GO
