...
#define GO(A) \
    if (my_AtkEventListenerInit_fct_##A == (uintptr_t)fct) return my_AtkEventListenerInit_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_AtkEventListenerInit_fct_##A == 0) {           \
        my_AtkEventListenerInit_fct_##A = (uintptr_t)fct; \
        return my_AtkEventListenerInit_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_AtkEventListener_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_AtkEventListener_fct_##A == (uintptr_t)fct) return my_AtkEventListener_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_AtkEventListener_fct_##A == 0) {           \
        my_AtkEventListener_fct_##A = (uintptr_t)fct; \
        return my_AtkEventListener_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_AtkKeySnoopFunc_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_AtkKeySnoopFunc_fct_##A == (uintptr_t)fct) return my_AtkKeySnoopFunc_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my_AtkKeySnoopFunc_fct_##A == 0) {           \
        my_AtkKeySnoopFunc_fct_##A = (uintptr_t)fct; \
        return my_AtkKeySnoopFunc_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_GSignalEmissionHook_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GSignalEmissionHook_fct_##A == (uintptr_t)fct) return my_GSignalEmissionHook_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_GSignalEmissionHook_fct_##A == 0) {           \
        my_GSignalEmissionHook_fct_##A = (uintptr_t)fct; \
        return my_GSignalEmissionHook_##A;               \
    }
    SUPER()
#undef GO
