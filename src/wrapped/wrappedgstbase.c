...
#define GO(A) \
    if (my_GstCollectPadsFunction_fct_##A == (uintptr_t)fct) return my_GstCollectPadsFunction_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_GstCollectPadsFunction_fct_##A == 0) {           \
        my_GstCollectPadsFunction_fct_##A = (uintptr_t)fct; \
        return my_GstCollectPadsFunction_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstCollectDataDestroyNotifyFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GstCollectDataDestroyNotify_fct_##A == (uintptr_t)fct) return my_GstCollectDataDestroyNotify_##A;
    SUPER()
#undef GO
#define GO(A)                                                    \
    if (my_GstCollectDataDestroyNotify_fct_##A == 0) {           \
        my_GstCollectDataDestroyNotify_fct_##A = (uintptr_t)fct; \
        return my_GstCollectDataDestroyNotify_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstCollectPadsEventFunctionFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GstCollectPadsEventFunction_fct_##A == (uintptr_t)fct) return my_GstCollectPadsEventFunction_##A;
    SUPER()
#undef GO
#define GO(A)                                                    \
    if (my_GstCollectPadsEventFunction_fct_##A == 0) {           \
        my_GstCollectPadsEventFunction_fct_##A = (uintptr_t)fct; \
        return my_GstCollectPadsEventFunction_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstCollectPadsQueryFunctionFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GstCollectPadsQueryFunction_fct_##A == (uintptr_t)fct) return my_GstCollectPadsQueryFunction_##A;
    SUPER()
#undef GO
#define GO(A)                                                    \
    if (my_GstCollectPadsQueryFunction_fct_##A == 0) {           \
        my_GstCollectPadsQueryFunction_fct_##A = (uintptr_t)fct; \
        return my_GstCollectPadsQueryFunction_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstCollectPadsClipFunctionFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GstCollectPadsClipFunction_fct_##A == (uintptr_t)fct) return my_GstCollectPadsClipFunction_##A;
    SUPER()
#undef GO
#define GO(A)                                                   \
    if (my_GstCollectPadsClipFunction_fct_##A == 0) {           \
        my_GstCollectPadsClipFunction_fct_##A = (uintptr_t)fct; \
        return my_GstCollectPadsClipFunction_##A;               \
    }
    SUPER()
#undef GO
...
static void* findGstCollectPadsBufferFunctionFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_GstCollectPadsBufferFunction_fct_##A == (uintptr_t)fct) return my_GstCollectPadsBufferFunction_##A;
    SUPER()
#undef GO
#define GO(A)                                                     \
    if (my_GstCollectPadsBufferFunction_fct_##A == 0) {           \
        my_GstCollectPadsBufferFunction_fct_##A = (uintptr_t)fct; \
        return my_GstCollectPadsBufferFunction_##A;               \
    }
    SUPER()
#undef GO
