...
GO2(SDL_qsort, vFEpLLp, my_qsort)
...
GO(SDL_RenderLogicalToWindow, vFpffpp)
...
// SDL_wcslcpy
GO(SDL_wcslen, LFp)
GOM(SDL_WriteBE16, LFEpW)
GOM(SDL_WriteBE32, LFEpu)
GOM(SDL_WriteBE64, LFEpU)
GOM(SDL_WriteLE16, LFEpW)
GOM(SDL_WriteLE32, LFEpu)
GOM(SDL_WriteLE64, LFEpU)
GOM(SDL_WriteU8, LFEpu)
