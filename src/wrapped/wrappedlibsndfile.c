...
#define GO(A) \
    if (my_sf_vio_get_filelen_fct_##A == (uintptr_t)fct) return my_sf_vio_get_filelen_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_sf_vio_get_filelen_fct_##A == 0) {           \
        my_sf_vio_get_filelen_fct_##A = (uintptr_t)fct; \
        return my_sf_vio_get_filelen_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sf_vio_seek_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sf_vio_seek_fct_##A == (uintptr_t)fct) return my_sf_vio_seek_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_sf_vio_seek_fct_##A == 0) {           \
        my_sf_vio_seek_fct_##A = (uintptr_t)fct; \
        return my_sf_vio_seek_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sf_vio_read_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sf_vio_read_fct_##A == (uintptr_t)fct) return my_sf_vio_read_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_sf_vio_read_fct_##A == 0) {           \
        my_sf_vio_read_fct_##A = (uintptr_t)fct; \
        return my_sf_vio_read_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sf_vio_write_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sf_vio_write_fct_##A == (uintptr_t)fct) return my_sf_vio_write_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_sf_vio_write_fct_##A == 0) {           \
        my_sf_vio_write_fct_##A = (uintptr_t)fct; \
        return my_sf_vio_write_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_sf_vio_tell_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sf_vio_tell_fct_##A == (uintptr_t)fct) return my_sf_vio_tell_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_sf_vio_tell_fct_##A == 0) {           \
        my_sf_vio_tell_fct_##A = (uintptr_t)fct; \
        return my_sf_vio_tell_##A;               \
    }
    SUPER()
#undef GO
