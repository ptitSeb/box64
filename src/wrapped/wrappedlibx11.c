...
#define GO(A) \
    if (my_wire_to_event_fct_##A == (uintptr_t)fct) return my_wire_to_event_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_wire_to_event_fct_##A == 0) {           \
        my_wire_to_event_fct_##A = (uintptr_t)fct; \
        return my_wire_to_event_##A;               \
    }
    SUPER()
#undef GO
...
#define GO(A) \
    if (my_wire_to_event_##A == fct) return (void*)my_wire_to_event_fct_##A;
    SUPER()
#undef GO
...
static void* findevent_to_wireFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_event_to_wire_fct_##A == (uintptr_t)fct) return my_event_to_wire_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_event_to_wire_fct_##A == 0) {           \
        my_event_to_wire_fct_##A = (uintptr_t)fct; \
        return my_event_to_wire_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_event_to_wireFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_event_to_wire_##A == fct) return (void*)my_event_to_wire_fct_##A;
    SUPER()
#undef GO
    return (void*)AddBridge(lib->w.bridge, iFppp, fct, 0, NULL);
}
...
static void* finderror_handlerFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_error_handler_fct_##A == (uintptr_t)fct) return my_error_handler_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_error_handler_fct_##A == 0) {           \
        my_error_handler_fct_##A = (uintptr_t)fct; \
        return my_error_handler_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_error_handlerFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_error_handler_##A == fct) return (void*)my_error_handler_fct_##A;
    SUPER()
#undef GO
...
static void* findioerror_handlerFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_ioerror_handler_fct_##A == (uintptr_t)fct) return my_ioerror_handler_##A;
    SUPER()
#undef GO
#define GO(A)                                        \
    if (my_ioerror_handler_fct_##A == 0) {           \
        my_ioerror_handler_fct_##A = (uintptr_t)fct; \
        return my_ioerror_handler_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_ioerror_handlerFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_ioerror_handler_##A == fct) return (void*)my_ioerror_handler_fct_##A;
    SUPER()
#undef GO
...
static void* findexterror_handlerFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_exterror_handler_fct_##A == (uintptr_t)fct) return my_exterror_handler_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_exterror_handler_fct_##A == 0) {           \
        my_exterror_handler_fct_##A = (uintptr_t)fct; \
        return my_exterror_handler_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_exterror_handlerFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_exterror_handler_##A == fct) return (void*)my_exterror_handler_fct_##A;
    SUPER()
#undef GO
...
static void* findclose_displayFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_close_display_fct_##A == (uintptr_t)fct) return my_close_display_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_close_display_fct_##A == 0) {           \
        my_close_display_fct_##A = (uintptr_t)fct; \
        return my_close_display_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_close_displayFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_close_display_##A == fct) return (void*)my_close_display_fct_##A;
    SUPER()
#undef GO
    return (void*)AddBridge(lib->w.bridge, iFpp, fct, 0, NULL);
}
...
static void* findregister_imFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_register_im_fct_##A == (uintptr_t)fct) return my_register_im_##A;
    SUPER()
#undef GO
#define GO(A)                                    \
    if (my_register_im_fct_##A == 0) {           \
        my_register_im_fct_##A = (uintptr_t)fct; \
        return my_register_im_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_register_imFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_register_im_##A == fct) return (void*)my_register_im_fct_##A;
    SUPER()
#undef GO
    return (void*)AddBridge(lib->w.bridge, iFppp, fct, 0, NULL);
}
...
static void* findXConnectionWatchProcFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XConnectionWatchProc_fct_##A == (uintptr_t)fct) return my_XConnectionWatchProc_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_XConnectionWatchProc_fct_##A == 0) {           \
        my_XConnectionWatchProc_fct_##A = (uintptr_t)fct; \
        return my_XConnectionWatchProc_##A;               \
    }
    SUPER()
#undef GO
...
static void* findxifeventFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_xifevent_fct_##A == (uintptr_t)fct) return my_xifevent_##A;
    SUPER()
#undef GO
#define GO(A)                                 \
    if (my_xifevent_fct_##A == 0) {           \
        my_xifevent_fct_##A = (uintptr_t)fct; \
        return my_xifevent_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXInternalAsyncHandlerFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XInternalAsyncHandler_fct_##A == (uintptr_t)fct) return my_XInternalAsyncHandler_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_XInternalAsyncHandler_fct_##A == 0) {           \
        my_XInternalAsyncHandler_fct_##A = (uintptr_t)fct; \
        return my_XInternalAsyncHandler_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXSynchronizeProcFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XSynchronizeProc_fct_##A == (uintptr_t)fct) return my_XSynchronizeProc_##A;
    SUPER()
#undef GO
#define GO(A)                                         \
    if (my_XSynchronizeProc_fct_##A == 0) {           \
        my_XSynchronizeProc_fct_##A = (uintptr_t)fct; \
        return my_XSynchronizeProc_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_XSynchronizeProcFct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_XSynchronizeProc_##A == fct) return (void*)my_XSynchronizeProc_fct_##A;
    SUPER()
#undef GO
    return (void*)AddBridge(lib->w.bridge, iFppp, fct, 0, NULL);
}
...
static void* findXLockDisplayFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XLockDisplay_fct_##A == (uintptr_t)fct) return my_XLockDisplay_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_XLockDisplay_fct_##A == 0) {           \
        my_XLockDisplay_fct_##A = (uintptr_t)fct; \
        return my_XLockDisplay_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXUnlockDisplayFct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_XUnlockDisplay_fct_##A == (uintptr_t)fct) return my_XUnlockDisplay_##A;
    SUPER()
#undef GO
#define GO(A)                                       \
    if (my_XUnlockDisplay_fct_##A == 0) {           \
        my_XUnlockDisplay_fct_##A = (uintptr_t)fct; \
        return my_XUnlockDisplay_##A;               \
    }
    SUPER()
#undef GO
...
static void* find_create_image_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_create_image_fct_##A == (uintptr_t)fct) return my_create_image_##A;
    SUPER()
#undef GO
#define GO(A)                                     \
    if (my_create_image_fct_##A == 0) {           \
        my_create_image_fct_##A = (uintptr_t)fct; \
        return my_create_image_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_create_image_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_create_image_##A == fct) return (void*)my_create_image_fct_##A;
    SUPER()
#undef GO
...
static void* find_destroy_image_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_destroy_image_fct_##A == (uintptr_t)fct) return my_destroy_image_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_destroy_image_fct_##A == 0) {           \
        my_destroy_image_fct_##A = (uintptr_t)fct; \
        return my_destroy_image_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_destroy_image_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_destroy_image_##A == fct) return (void*)my_destroy_image_fct_##A;
    SUPER()
#undef GO
...
static void* find_get_pixel_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_get_pixel_fct_##A == (uintptr_t)fct) return my_get_pixel_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_get_pixel_fct_##A == 0) {           \
        my_get_pixel_fct_##A = (uintptr_t)fct; \
        return my_get_pixel_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_get_pixel_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_get_pixel_##A == fct) return (void*)my_get_pixel_fct_##A;
    SUPER()
#undef GO
...
static void* find_put_pixel_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_put_pixel_fct_##A == (uintptr_t)fct) return my_put_pixel_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_put_pixel_fct_##A == 0) {           \
        my_put_pixel_fct_##A = (uintptr_t)fct; \
        return my_put_pixel_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_put_pixel_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_put_pixel_##A == fct) return (void*)my_put_pixel_fct_##A;
    SUPER()
#undef GO
...
static void* find_sub_image_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_sub_image_fct_##A == (uintptr_t)fct) return my_sub_image_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_sub_image_fct_##A == 0) {           \
        my_sub_image_fct_##A = (uintptr_t)fct; \
        return my_sub_image_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_sub_image_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_sub_image_##A == fct) return (void*)my_sub_image_fct_##A;
    SUPER()
#undef GO
...
static void* find_add_pixel_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_add_pixel_fct_##A == (uintptr_t)fct) return my_add_pixel_##A;
    SUPER()
#undef GO
#define GO(A)                                  \
    if (my_add_pixel_fct_##A == 0) {           \
        my_add_pixel_fct_##A = (uintptr_t)fct; \
        return my_add_pixel_##A;               \
    }
    SUPER()
#undef GO
...
static void* reverse_add_pixel_Fct(library_t* lib, void* fct)
{
    ...
    if (CheckBridged(lib->w.bridge, fct))
        return (void*)CheckBridged(lib->w.bridge, fct);
#define GO(A) \
    if (my_add_pixel_##A == fct) return (void*)my_add_pixel_fct_##A;
    SUPER()
#undef GO
...
static void* find_async_handler_Fct(void* fct)
{
    ...
    if (GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
#define GO(A) \
    if (my_async_handler_fct_##A == (uintptr_t)fct) return my_async_handler_##A;
    SUPER()
#undef GO
#define GO(A)                                      \
    if (my_async_handler_fct_##A == 0) {           \
        my_async_handler_fct_##A = (uintptr_t)fct; \
        return my_async_handler_##A;               \
    }
    SUPER()
#undef GO
...
void* my_XCreateImage(x64emu_t* emu, void* disp, void* vis, uint32_t depth, int32_t fmt, int32_t off, void* data, uint32_t w, uint32_t h, int32_t pad, int32_t bpl);

int32_t my_XInitImage(x64emu_t* emu, void* img);

void* my_XGetImage(x64emu_t* emu, void* disp, void* drawable, int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t plane, int32_t fmt);

int32_t my_XPutImage(x64emu_t* emu, void* disp, void* drawable, void* gc, void* image, int32_t src_x, int32_t src_y, int32_t dst_x, int32_t dst_y, uint32_t w, uint32_t h);

void* my_XGetSubImage(x64emu_t* emu, void* disp, void* drawable, int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t plane, int32_t fmt, void* image, int32_t dst_x, int32_t dst_y);
...
#define GO(A) \
    if (my_XNGeometryCallback_fct_##A == (uintptr_t)fct) return my_XNGeometryCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                           \
    if (my_XNGeometryCallback_fct_##A == 0) {           \
        my_XNGeometryCallback_fct_##A = (uintptr_t)fct; \
        return my_XNGeometryCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNDestroyCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNDestroyCallback_fct_##A == (uintptr_t)fct) return my_XNDestroyCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                          \
    if (my_XNDestroyCallback_fct_##A == 0) {           \
        my_XNDestroyCallback_fct_##A = (uintptr_t)fct; \
        return my_XNDestroyCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNPreeditStartCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNPreeditStartCallback_fct_##A == (uintptr_t)fct) return my_XNPreeditStartCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_XNPreeditStartCallback_fct_##A == 0) {           \
        my_XNPreeditStartCallback_fct_##A = (uintptr_t)fct; \
        return my_XNPreeditStartCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNPreeditDoneCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNPreeditDoneCallback_fct_##A == (uintptr_t)fct) return my_XNPreeditDoneCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_XNPreeditDoneCallback_fct_##A == 0) {           \
        my_XNPreeditDoneCallback_fct_##A = (uintptr_t)fct; \
        return my_XNPreeditDoneCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNPreeditDrawCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNPreeditDrawCallback_fct_##A == (uintptr_t)fct) return my_XNPreeditDrawCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_XNPreeditDrawCallback_fct_##A == 0) {           \
        my_XNPreeditDrawCallback_fct_##A = (uintptr_t)fct; \
        return my_XNPreeditDrawCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNPreeditCaretCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNPreeditCaretCallback_fct_##A == (uintptr_t)fct) return my_XNPreeditCaretCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                               \
    if (my_XNPreeditCaretCallback_fct_##A == 0) {           \
        my_XNPreeditCaretCallback_fct_##A = (uintptr_t)fct; \
        return my_XNPreeditCaretCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNPreeditStateNotifyCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNPreeditStateNotifyCallback_fct_##A == (uintptr_t)fct) return my_XNPreeditStateNotifyCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                                     \
    if (my_XNPreeditStateNotifyCallback_fct_##A == 0) {           \
        my_XNPreeditStateNotifyCallback_fct_##A = (uintptr_t)fct; \
        return my_XNPreeditStateNotifyCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNStatusStartCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNStatusStartCallback_fct_##A == (uintptr_t)fct) return my_XNStatusStartCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                              \
    if (my_XNStatusStartCallback_fct_##A == 0) {           \
        my_XNStatusStartCallback_fct_##A = (uintptr_t)fct; \
        return my_XNStatusStartCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNStatusDoneCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNStatusDoneCallback_fct_##A == (uintptr_t)fct) return my_XNStatusDoneCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_XNStatusDoneCallback_fct_##A == 0) {           \
        my_XNStatusDoneCallback_fct_##A = (uintptr_t)fct; \
        return my_XNStatusDoneCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNStatusDrawCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNStatusDrawCallback_fct_##A == (uintptr_t)fct) return my_XNStatusDrawCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                             \
    if (my_XNStatusDrawCallback_fct_##A == 0) {           \
        my_XNStatusDrawCallback_fct_##A = (uintptr_t)fct; \
        return my_XNStatusDrawCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNR6PreeditCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNR6PreeditCallback_fct_##A == (uintptr_t)fct) return my_XNR6PreeditCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                            \
    if (my_XNR6PreeditCallback_fct_##A == 0) {           \
        my_XNR6PreeditCallback_fct_##A = (uintptr_t)fct; \
        return my_XNR6PreeditCallback_##A;               \
    }
    SUPER()
#undef GO
...
static void* findXNStringConversionCallbackFct(void* fct)
{
    ...
    if ((p = GetNativeFnc((uintptr_t)fct))) return p;
#define GO(A) \
    if (my_XNStringConversionCallback_fct_##A == (uintptr_t)fct) return my_XNStringConversionCallback_##A;
    SUPER()
#undef GO
#define GO(A)                                                   \
    if (my_XNStringConversionCallback_fct_##A == 0) {           \
        my_XNStringConversionCallback_fct_##A = (uintptr_t)fct; \
        return my_XNStringConversionCallback_##A;               \
    }
    SUPER()
#undef GO
...
EXPORT void* my_XCreateImage(x64emu_t* emu, void* disp, void* vis, uint32_t depth, int32_t fmt, int32_t off, void* data, uint32_t w, uint32_t h, int32_t pad, int32_t bpl)
{
...
EXPORT void* my_XGetImage(x64emu_t* emu, void* disp, void* drawable, int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t plane, int32_t fmt)
{
...
EXPORT int32_t my_XPutImage(x64emu_t* emu, void* disp, void* drawable, void* gc, void* image, int32_t src_x, int32_t src_y, int32_t dst_x, int32_t dst_y, uint32_t w, uint32_t h)
{
...
EXPORT void* my_XGetSubImage(x64emu_t* emu, void* disp, void* drawable, int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t plane, int32_t fmt, void* image, int32_t dst_x, int32_t dst_y)
{
