...
#define __INT8_TYPE__ __int8_t
#define __INT16_TYPE__ __int16_t
#define __INT32_TYPE__ __int32_t
#define __INT64_TYPE__ __int64_t
#define __UINT8_TYPE__ __uint8_t
#define __UINT16_TYPE__ __uint16_t
#define __UINT32_TYPE__ __uint32_t
#define __UINT64_TYPE__ __uint64_t
#define __INT_LEAST8_TYPE__ int8_t
#define __INT_LEAST16_TYPE__ int16_t
#define __INT_LEAST32_TYPE__ int32_t
#define __INT_LEAST64_TYPE__ int64_t
#define __UINT_LEAST8_TYPE__ uint8_t
#define __UINT_LEAST16_TYPE__ uint16_t
#define __UINT_LEAST32_TYPE__ uint32_t
#define __UINT_LEAST64_TYPE__ uint64_t
#define __INT_FAST8_TYPE__ int8_t
#define __INT_FAST16_TYPE__ int16_t
#define __INT_FAST32_TYPE__ int32_t
#define __INT_FAST64_TYPE__ int64_t
#define __UINT_FAST8_TYPE__ uint8_t
#define __UINT_FAST16_TYPE__ uint16_t
#define __UINT_FAST32_TYPE__ uint32_t
#define __UINT_FAST64_TYPE__ uint64_t
#define __INTPTR_TYPE__ signed long
#define __UINTPTR_TYPE__ unsigned long
#define __INTMAX_TYPE__ int64_t
#define __UINTMAX_TYPE__ uint64_t
